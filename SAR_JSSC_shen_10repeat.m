function [adco,Energy_mean]=SAR_JSSC_shen_10repeat
...
Cn_tot=sum(Cn);
factor=(Cp_tot+Cn_tot-Cp(5)-Cp(10)-Cp(15)-sum(Cp(20:29))-Cn(5)-Cn(10)-Cn(15)-sum(Cn(20:29)))/(Cp_tot+Cn_tot);
adco=[];
E=[];
for t=(0:len-1)*(1/fs)
A=zeros(1,LenC-1);
...
E=[E;Energy];
F=decimal2binary(-2048-128-8-5,17);
%The calibration number is -2048-128-8
B=zeros(1,16);
C=zeros(1,16);
%First row plus the third row -4096-256-16 (F1~F17)
% + Compensation Capacotor A(5) A(10) A(15) A(20:29)->G
G=decimal2binary(sum(A(20:29)),4);
[B(16),C(16)]=full_adder(F(17),G(4),0);
[B(15),C(15)]=full_adder(F(16),G(3),C(16));
[B(14),C(14)]=full_adder(F(15),G(2),C(15));
[B(13),C(13)]=full_adder(F(14),G(1),C(14));
